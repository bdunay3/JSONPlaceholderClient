...
// This uses a slightly modified version of something John Sundel came up with. I couldn't figure out a way to make this work without passing in an inout array of AnyCancellable.
// Original post can be found here: https://www.swiftbysundell.com/articles/unit-testing-combine-based-swift-code/#awaiting-expectations
